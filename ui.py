...
import cv2
from PyQt5.QtCore import QTimer, Qt, pyqtSignal, QUrl, QPropertyAnimation, QEasingCurve, pyqtProperty
...
from PyQt5.QtCore import (
    ...
    QThread, pyqtSignal, QSize, QPoint, QRect
)
from PyQt5.QtGui import (
    QColor, QPalette, QFont, QFontDatabase, QPainter,
    QPen, QBrush, QLinearGradient, QRadialGradient,
    QPixmap, QIcon, QPainterPath, QMovie
)
...
class CameraFeedPanel(QFrame):
    ...
    def show_web_view(self):
        if not self.web_view:
            ...
            self.web_view.setUrl(QUrl("http://127.0.0.1:5500/control.html"))
        ...
        try:
            ...
            if ret:
                ...
                if new_w > 0 and new_h > 0:
                    ...
                    qt_image = QImage(resized_frame.data, new_w, new_h, 
...
class KineticArchitectDashboard(QMainWindow):
    def __init__(self):
        ...
        self.camera_panel = CameraFeedPanel()
...
if __name__ == "__main__":
    ...
    window = KineticArchitectDashboard()
    window.show()
    sys.exit(app.exec_())